...
# AGENT_TRAIN_FORMAT['m1_deep_geometry'] = AGENT_TRAIN_FORMAT['sac']
# AGENT_TRAIN_FORMAT['m4_pixel_e2e'] = AGENT_TRAIN_FORMAT['sac']
# AGENT_TRAIN_FORMAT['m6_EKVi'] = AGENT_TRAIN_FORMAT['sac']
# AGENT_TRAIN_FORMAT['m7_EKG'] = AGENT_TRAIN_FORMAT['sac']
# AGENT_TRAIN_FORMAT['m8_keypoint_bottleneck'] = AGENT_TRAIN_FORMAT['sac']
...
class Logger(object):
    ...
    def _should_save_checkpoint(self, step):
        return step % self._save_frequency == 0
    ...
    def save_check_point(self, actor, step):
        if not self._should_save_checkpoint(step):
            return
