#!/bin/bash
#SBATCH --job-name=L128_m1_deep_geometry
...
python train_meta_world.py agent=m1_deep_geometry128 headless=True experiment=meta_press_button128LR actor_lr=5e-4 critic_lr=5e-4
# ---------------------------------------------------------------------
